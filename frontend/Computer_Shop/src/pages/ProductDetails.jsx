      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <div className="mt-6 p-4 border rounded-lg shadow-sm bg-white dark:bg-surface-dark">
            <h3
              className={`text-xl font-semibold mb-4 text-center cursor-pointer ${
                theme === "dark"
                  ? "text-text-dark-primary"
                  : "text-text-light-primary"
              }`}
              onClick={openReviewForm} // Open the modal on click
            >
              Rate this Item
            </h3>
...
//     navigate("/review-form"); // Navigate to the ReviewForm route
//   };
